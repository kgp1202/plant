 ...
 */
public class KakaoBtnLayout extends FrameLayout {
    Context mycont;
    public KakaoBtnLayout(Context context) {
        super(context);
        mycont=context;
    }
    public KakaoBtnLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        mycont=context;
    }
    public KakaoBtnLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onAttachedToWindow() {
        ...
        inflate(getContext(), R.layout.kakao_btn, this);
        setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Animation anim1= AnimationUtils.loadAnimation(mycont, R.anim.scale_down);
                Animation anim2=AnimationUtils.loadAnimation(mycont,R.anim.scale_up);
